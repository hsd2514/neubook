...
- [x] [#2](https://github.com/hsd2514/neubook/issues/2) P0: Prevent overlapping double-bookings (interval overlap + capacity) - assignee: `hsd2514`
- [x] [#6](https://github.com/hsd2514/neubook/issues/6) P0: Enforce required booking questions on FE + BE - assignee: `hsd2514`
